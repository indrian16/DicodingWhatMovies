    ...
    fun getMovies(): List<Movie> {
        return listOf(
            ...
            Movie(
                ...
                genreIds = listOf(16, 35, 10751, 12),
            ...
            Movie(
                ...
                genreIds = listOf(16, 12, 14, 10751, 28),
    ...
    fun getTVShows(): List<TVShow> {
        return listOf(
            ...
            TVShow(
                ...
                genreIds = listOf(10759, 10765, 18),
                name = "Superman & Lois",
            ...
            TVShow(
                id = 85801,
                backdropPath = "/m02LYiYa5Lki1YqasKOoQ9mUhk4.jpg",
                firstAirDate = "2019-11-12",
                genreIds = listOf(10751, 35, 18),
            ...
            TVShow(
                id = 65820,
                backdropPath = "/5VltHQJXdmbSD6gEJw3R8R1Kbmc.jpg",
                firstAirDate = "2016-09-23",
                genreIds = listOf(9648, 10765, 10759),
                name = "Van Helsing",
            ...
            TVShow(
                ...
                popularity = 327.662,
                posterPath = "/jDCgWVlejIo8sQYxw3Yf1cVQUIL.jpg",
                voteAverage = 7.8,
                voteCount = 2428
            ),
            TVShow(
                id = 65334,
                backdropPath = "/9RqliZcoDEjSEISeA0LY9meAiNv.jpg",
                firstAirDate = "2015-10-19",
                genreIds = listOf(10759, 16, 10762),
                ...
                popularity = 349.738,
                posterPath = "/qxbW47zmgFyBVmZSIqD9NA1DEjT.jpg",
                voteAverage = 7.9,
                voteCount = 2625
            ),
            TVShow(
                id = 114621,
                backdropPath = "/qcKN95e2HJzfmypDqBUHW2Ti751.jpg",
                firstAirDate = "2021-03-26",
                genreIds = listOf(10751, 35),
                name = "The Mighty Ducks: Game Changers",
                overview = "In present day Minnesota, the Mighty Ducks have evolved from scrappy underdogs to an ultra-competitive, powerhouse youth hockey team. After 12-year-old Evan is unceremoniously cut from the Ducks, he and his mom Alex set out to build their own ragtag team of misfits to challenge the cutthroat, win-at-all-costs culture of competitive youth sports.",
                popularity = 294.24,
                posterPath = "/625YZePh2KoSX61xVXt3JwuSq4m.jpg",
                voteAverage = 8.4,
                voteCount = 62
            ),
            TVShow(
                id = 44006,
                backdropPath = "/W5geO8tq68ng4TsXyZ81phcPiz.jpg",
                ...
                popularity = 241.824,
                posterPath = "/6AccYL0eb7uzHn98IKaNjvJbyuA.jpg",
                voteAverage = 8.4,
                voteCount = 1353
            ),
            TVShow(
                id = 66084,
                backdropPath = "/exZrSuXA05mhklSSoZ65wT6xeNZ.jpg",
                firstAirDate = "2014-09-27",
                ...
                popularity = 227.497,
                posterPath = "/fSRyd3ZNZY41awncagc8oqV739M.jpg",
                voteAverage = 8.0,
                voteCount = 581
            ),
        )
